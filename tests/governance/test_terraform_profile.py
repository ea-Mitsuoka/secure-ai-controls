...
class TerraformGovernanceProfileTest(unittest.TestCase):
    ...
    def test_profile_directory_ownership_matches_repository_role(self):
        profile_directory = ".github/governance/profiles/"
        parent_repository = self.manifest["parent"]["repository"]

        if parent_repository.endswith("/ai-dev-foundation"):
            ...
            self.assertTrue(parent_repository.endswith("/terraform-gcp-template"))

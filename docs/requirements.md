...
| 10 | リポジトリ化のタイミング（2026-07-16、旧未決6） | ai-dev-foundation テンプレートは適用済み（Initial commit）。達成過程②基盤試作の着手時（2026-09予定）に**インスタンス化**する（プレースホルダ置換・Makefile 実装・pre-commit/governance 有効化） | §6 |

...
- **本ワークスペース**: 現状は軽量なドキュメントのみ。IaC着手時に ai-dev-foundation テンプレートから scaffold してリポジトリ化する。
...
| 10 | リポジトリ化のタイミング（2026-07-16、旧未決6） | 達成過程②基盤試作の着手時（2026-09予定）に ai-dev-foundation テンプレートから scaffold してリポジトリ化する | §6 |
